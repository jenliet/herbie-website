...
const ContactInfo: React.FC = () => {
  return (
    <div className="bg-brandBlue/50 rounded-[25px] shadow-lg p-6 md:p-10 lg:p-14 flex flex-col gap-6">
...
<div>
  ...
  <a
    ...
    className="font-inter text-base text-gray-800 opacity-80 hover:text-brandDark transition italic"
  >
