...
const Hero: React.FC = () => {
  return (
<section className="w-full overflow-hidden flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-12 lg:px-24 py-20 mx-auto max-w-7xl">
  {/* ✅ Left side text */}
  <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
    ...
    <p className="text-lg md:text-xl text-gray-700 opacity-80">
  ...
  <div className="w-full md:w-1/2 flex justify-center md:justify-end relative overflow-hidden">
    <div className="relative flex items-center justify-center">
      ...
      <div className="hidden lg:flex flex-col gap-6 absolute top-8 left-[110%]">
